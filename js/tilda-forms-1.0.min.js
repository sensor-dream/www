...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
        ...
        if (o || n || a) {
            var i = "tilda-forms-payments-1.0",
                s;
            if (!document.head.querySelector('script[src*="' + i + '"]'))(s = document.createElement("script")).type = "text/javascript", s.src = "js/" + i + ".min.js", s.onerror = function() {
        ...
        if (!0 !== window.isInitEventsCustomMask) {
            ...
            t.type = "text/javascript", t.src = "js/tilda-forms-custommask-1.0.min.js", document.head.appendChild(t), t.onload = function() {
        ...
        for (var e = t_forms__getElement(t), r = e.querySelectorAll(".js-tilda-rule"), o = [], n = !0, a, i = t_forms__getConditionCheckHandler(e).isHiddenByCondition, s = 0; s < r.length; s++) {
            ...
            if (!i(l)) {
                ...
                if ((w.length && !E || E && F) && (n = !1), d && (b || E && !F)) p.type.push("req");
                else {
                    switch (u) {
                        case "email":
        ...
        if ("y" === v) {
            var C = window.tcart_minorder > 0,
                ...
                T, p, p;
            if (C)
                if ((window.tcart.prodamount_withdiscount > 0 ? window.tcart.prodamount_withdiscount : void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 ? window.tcart.prodamount_withdyndiscount : window.tcart.prodamount) < window.tcart_minorder)(p = {
                    obj: {},
                    type: []
        ...
        for (var f = 0; f < e.length; f++)
            ...
            if (Array.prototype.forEach.call(h, (function(t) {
                ...
                if (y && y.length) {
                    var v, b = '.t1093 .t-popup[data-tooltip-hook="' + y[y.length - 1] + '"]',
...
function t_forms__onSuccess(t) {
    var e = t_forms__getElement(t),
        ...
        l, d, u = n.clientHeight - (i + s) + (n.getBoundingClientRect().top + window.pageYOffset),
...
function t_forms__updateAllSystemVariables(t) {
    var e;
    if (t_forms__isTesterPage()) {
        var r = t.closest(".t-rec"),
            o, n;
        t_forms__getUsedVariables([r], {
            unique: !0
        }).filter(t_forms__isSystemVariable).forEach((function(t) {
            t_forms__updateSystemVariable(r, r, t)
        }))
    }
}
...
function t_forms__parseVariables(t) {
    var e;
    if (!t_forms__isTesterPage()) return Promise.resolve();
    var r = t_forms__replaceVariablesWithPlaceholders(t),
        o;
    return r.length ? t_forms__bindFormVariablesToPlaceholders(t.closest(".t-rec"), r) : Promise.resolve()
}
    ...
    for (var e = [], r = t.querySelectorAll("input, textarea, button, select"), o, n = t_forms__getConditionCheckHandler(t).isHiddenByCondition, a = 0; a < r.length; a++)
        if (!(!r[a].name || r[a].disabled || ["file", "reset", "submit", "button"].indexOf(r[a].type) > -1 || n(r[a])))
            if ("select-multiple" !== r[a].type) {
                ...
                for (var l = r[a].options, d = 0; d < l.length; d++) l[d].selected && e.push({
                    name: l[d].name,
                    value: l[d].value
                });
    return e
