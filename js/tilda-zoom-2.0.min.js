...
function t_zoomHandler(t) {
    ...
    i.classList.add("t-carousel__zoomer__track"), a.appendChild(i);
    ...
    d && (d.style.display = "flex"), t_zoom_setModalColor(s), t_zoom__createAndLoopSlider(t), t_zoom__getEventOnBtn(), document.body.classList.add("t-zoomer__show_fixed"), t_zoom__initSingleZoom(), t_zoom_checkForScale(), t_zoom_lockScroll(), window.t_zoom__isMobile ? (t_zoom_initSwipe(), t_zoom_initCloseSwipe(), window.addEventListener("orientationchange", t_zoom__updateActiveSlidePos)) : window.addEventListener("resize", t_zoom__updateActiveSlidePos), window.tzoomopenonce = !0, t_zoom__initEventsonMobile()
}
...
function t_zoom__addingImgsIntoCarousel(t) {
    ...
    Array.prototype.forEach.call(o, (function(t, e) {
        var r = t.getAttribute("data-img-zoom-url"),
            ...
            c = "",
            s = r ? r.split(",") : "";
        if ("IMG" !== t.nodeName && "DIV" !== t.nodeName || (n = t.getAttribute("title") || "", c = t.getAttribute("data-img-zoom-descr") || ""), n) {
            var _ = document.createElement("div");
            _.classList.add("t-zoomer__title"), _.classList.add("t-descr"), _.classList.add("t-descr_xxs"), _.textContent = n, a && a.titleFontFamily && (_.style.fontFamily = a.titleFontFamily)
        }
        if (c) {
            var d = document.createElement("div");
            d.classList.add("t-zoomer__descr"), d.classList.add("t-descr"), d.classList.add("t-descr_xxs"), d.textContent = c, a && a.descrFontFamily && (d.style.fontFamily = a.descrFontFamily)
        }
        ...
        if (y.classList.add("t-carousel__zoomer__img"), l ? (y.classList.add("t-img"), y.setAttribute("data-original", s), 0 !== e && e !== o.length - 1 || y.setAttribute("data-lazy-rule", "skip")) : y.src = s, m.appendChild(u), u.appendChild(y), n || c || window.t_zoom__isMobile) {
            var p = document.createElement("div");
            p.classList.add("t-zoomer__comments"), n && p.appendChild(_), c && p.appendChild(d), m.appendChild(p)
        }
        i.appendChild(m)
    }))
}
...
function t_zoom__createAndLoopSlider(t) {
    ...
    if (o && r.length) {
        ...
        if (window.t_zoom__isMobile) {
            var a = Array.prototype.reduce.call(r, (function(t, e) {
        ...
        i && t_onFuncLoad("t_lazyload_update", t_lazyload_update)
    }
}

function t_zoom__hideInnactiveSlides(t, e) {
    if (t) {
        var o = ".t-carousel__zoomer__item:not(:first-child):not(:last-child)",
            r = Array.prototype.slice.call(e.querySelectorAll(o));
        if (!(r.length <= 6)) {
            var n = t_zoom__getCurrentSlideIndex(t),
                a = [n];
            a.push(0 === n ? r.length : n - 1), a.push(n === r.length ? 0 : n + 1);
            var i = "t-carousel__zoomer__item-innactive";
            r.forEach((function(t) {
                var e = t_zoom__getCurrentSlideIndex(t),
                    o = -1 !== a.indexOf(e) ? "remove" : "add";
                t.classList[o](i)
            }))
        }
    }
...
function t_zoom_showSlide(t) {
    ...
    var l = o[n].offsetLeft;
    if (r.classList.remove("active"), o[n].classList.add("active"), e.style.transform = "translateX(" + -l + "px)", t_zoom__hideInnactiveSlides(o[n], e), a) {
        e.removeAttribute("data-cached-zoom");
        var c = new Event("transitionend");
        e.dispatchEvent(c)
    }
    if ("y" === window.lazy) {
        t_onFuncLoad("t_lazyload_update", t_lazyload_update);
        var s = o[n].querySelector("img");
        s && !s.src && setTimeout((function() {
            t_onFuncLoad("t_lazyload_update", t_lazyload_update)
        }), 200)
    }
}
...
function t_zoom_transitForLoop(t) {
    var e = document.querySelector(".t-carousel__zoomer__track"),
        ...
        r, n;
    if (!t) return 1;
    "start" === t && (r = o.length - 2), "end" === t && (r = 1), n = o[r].offsetLeft, Array.prototype.forEach.call(o, (function(t, e) {
...
function t_zoom_hexToRgb(t) {
    ...
    t = t.replace(e, (function(t, e, o, r) {
        return e + e + o + o + r + r
    }));
