...
function t_popup__resizePopup(t) {
    ...
    !t || (e = t.querySelector(".t-popup__container")) && (p = getComputedStyle(e, null), o = parseInt(p.paddingTop) || 0, p = parseInt(p.paddingBottom) || 0, o = e.clientHeight - (o + p), p = 120, t = 1093 === (n = Number(t.getAttribute("data-record-type"))) || 121 === n && t.querySelector(".t1093"), 364 !== n && 365 !== n || (p = 30), 868 !== n && 331 !== n && 358 !== n && 1013 !== n && 746 !== n && !t || (p = 0), o > window.innerHeight - p ? e.classList.add("t-popup__container-static") : e.classList.remove("t-popup__container-static"))
}
