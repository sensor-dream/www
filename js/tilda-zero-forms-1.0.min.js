...
function t_zeroForms__createFormButton(t, e, r, o) {
    var n = document.createElement("div"),
        ...
        a = (i.type = "submit", i.classList.add("t-submit"), "center" === o.buttonalign && (i.style.marginLeft = "auto", i.style.marginRight = "auto"), i.style.padding = "0 15px", i.style.display = "block", o.buttontitle);
...
function t_zeroForms__setBtnInlineStyles(t, e) {
    ...
    e.style.width = t.buttonwidth ? t.buttonwidth + "px" : "100%", r && (e.style.fontWeight = r), t.buttonheight && (e.style.height = t.buttonheight + "px"), "center" === t.buttonalign && (e.style.marginLeft = "auto", e.style.marginRight = "auto"), (t.buttonshadowsize || t.buttonshadowopacity) && (e.style.boxShadow = "0px 0px " + (t.buttonshadowsize ? t.buttonshadowsize + "px" : "10px") + " 0px rgba(0, 0, 0, " + (t.buttonshadowopacity ? t.buttonshadowopacity / 100 : "0.3") + ")")
}
...
function t_zeroForms__setScriptOrStyle(t, e, r, o, n) {
    var i, a;
    document.getElementById(t) || (i = "", a = document.createElement(o), r ? a.textContent = r : ("script" === o ? (a.src = i + "js/" + e, a.async = !0, a.charset = "utf-8") : "link" === o && (a.href = i + "css/" + e, a.rel = "stylesheet"), a.onerror = function() {
...
function t_zeroForms__getFieldValue(n, i, a) {
    if (n) {
        var s, l, d, t = n.closest(".r"),
            t = "ab" + (t ? t.id.replace("rec", "") : ""),
            c = [];
        if (void 0 !== window.tn) return c = void 0 !== window.tn[t] ? (l = window.tn[t].curResolution, window.tn[t].screens.slice().reverse()) : (l = window.tn.curResolution, void 0 !== window.tn.screens ? window.tn.screens.slice().reverse() : [1200, 960, 640, 480, 320]), d = "data-field" === i ? "-value" : "", c.forEach(function(t, e) {
            if (0 === e && t <= +l && (s = n.getAttribute(i + "-" + a + d)), 0 < e && +l === t) {
                if (s = n.getAttribute(i + "-" + a + "-res-" + t + d), 1 < e && !s)
                    for (var r = c.slice(1, e), o = r.length - 1; 0 <= o && !(s = n.getAttribute(i + "-" + a + "-res-" + r[o] + d)); o--);
                s = s || n.getAttribute(i + "-" + a + d)
            }
        }), s || ""
    }
}
